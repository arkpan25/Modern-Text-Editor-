...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			BasicDocument BasDoc = new BasicDocument(text);
			double basicFleshScore = BasDoc.getFleschScore();
			long endTime = System.currentTimeMillis();
			System.out.print("BasicDocument took " + (endTime - startTime) + " milliseconds"+"\t");
			long startTime1 = System.currentTimeMillis();
			EfficientDocument EffDoc = new EfficientDocument(text);
			double efficientFleshScore = EffDoc.getFleschScore();
			long endTime1 = System.currentTimeMillis();
			System.out.print("EfficientDocument took " + (endTime1 - startTime1) + " milliseconds"+"\n");
